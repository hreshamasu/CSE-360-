...
//			statement.execute("DROP ALL OBJECTS");
	...
	public void addMessage(Message message) throws SQLException {
	    String q = "INSERT INTO private_messages (sender, receiver, content) VALUES (?, ?, ?)";
	    try (PreparedStatement pstmt = connection.prepareStatement(q)) {
	...
	// Retrieve all messages for a given receiver
	public List<Message> getMessagesForUser(String receiver) throws SQLException {
	    List<Message> messages = new ArrayList<>();
	    String q = "SELECT * FROM private_messages WHERE receiver = ?";
	    try (PreparedStatement pstmt = connection.prepareStatement(q)) {
